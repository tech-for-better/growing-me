export const ContentData = {
  "Great To Meet You": {
    ...
    make: {
      1: {
        img: "public/assets/simple_make.svg",
        txt: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat",
      },
      2: {
        img: "public/assets/simple_make.svg",
  ...
  "Your Brain is Amazing": {
    ...
    play: {
      1: {
        ...
        txt: "Welcome back to the Play den! Today is all about Your Amazing Brain! We'll start, like we always start Growing Me time with a fun and relaxing activity together. Let's go!",
      },
      2: {
    ...
    think: {
      1: {
        img: "https://vxavjjcpsaykzxkhimor.supabase.in/storage/v1/object/sign/private/navigation/content_top_nav/THINK_BANK.svg?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJwcml2YXRlL25hdmlnYXRpb24vY29udGVudF90b3BfbmF2L1RISU5LX0JBTksuc3ZnIiwiaWF0IjoxNjI4NjA3MTY1LCJleHAiOjE5NDM5NjcxNjV9.BKX5zF6cgi0fW1lbld4jiBtpZavbjIogUUvH4nl4lEc",
        txt: "Welcome to The Think Bank! Here's a story about your amazing brain! Lets go!",
      },
      2: {
    ...
    make: {
      1: {
        img: "https://vxavjjcpsaykzxkhimor.supabase.in/storage/v1/object/sign/private/navigation/content_top_nav/MAKE_STATION.svg?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJwcml2YXRlL25hdmlnYXRpb24vY29udGVudF90b3BfbmF2L01BS0VfU1RBVElPTi5zdmciLCJpYXQiOjE2Mjg2MDcxNjMsImV4cCI6MTk0Mzk2NzE2M30.7nqB8QGbTIj-0wnNnttqllNfeXTuWhRPgWcTfXzmlOE",
        txt: "Welcome back to the Making Station! Today, you are invited to make a calm bag to keep your amazing brain happy! Let's go!",
      },
      2: {
